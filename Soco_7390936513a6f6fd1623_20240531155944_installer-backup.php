...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = 'Soco_7390936513a6f6fd1623_20240531155944_archive.zip';
        const ARCHIVE_SIZE       = '65846211';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '7390936-31155944';
        const SECONDARY_PACKAGE_HASH = '6c62848-31155944';
        const VERSION            = '1.5.9';
